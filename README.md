...
| 3 | [Setting Up YouTube](https://dev.to/towernter/automate-spotify-and-youtube-playlists-chapter-3-setting-up-youtube-1mfb) | Enabling the YouTube Data API on Google Cloud and finding your playlist ID |
| 4 | [Writing the Code](https://dev.to/towernter/automate-spotify-and-youtube-playlists-chapter-4-writing-the-code-1k97) | A plain-English walkthrough of all three Python files and how the sync logic works |
